import { translate, EventEmitter } from '@near-wallet-selector/core';
...
var uncurryThis$i = NATIVE_BIND$2 && bind$5.bind(call$c, call$c);
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$8 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O, P) {
  ...
  if (hasOwn$9(O, P)) return createPropertyDescriptor$2(!call$9(propertyIsEnumerableModule.f, O, P), O[P]);
};
...
var push = uncurryThis$8(test.push);
...
var getIterator$1 = function (argument, usingIterator) {
  ...
  if (aCallable$2(iteratorMethod)) return anObject$7(call$6(iteratorMethod, argument));
...
function renderLedgerSelectAccount(module, accounts) {
  var _a, _b, _c;
...
function renderWalletConnectionFailed(module, err) {
  var _a;
            ...
            <div class="connection">
              <div class="error-wrapper">
                <div class="error">
                  ...
                  ${!(module === null || module === void 0 ? void 0 : module.metadata.deprecated) && (module === null || module === void 0 ? void 0 : module.metadata.available) ? `<button id='retry-button'>${translate("modal.ledger.retry")}</button>` : ""}
              </div>
            </div>
          </div>
        </div>
...
function renderLedgerAccountsOverviewList(module, accounts, selectedAccounts) {
  var _a, _b, _c;
  ...
  return __awaiter(this, void 0, void 0, function* () {
    ...
    <div class="nws-modal-header-wrapper">
      <button class="back-button" id="back-button"><svg width="8" height="14" viewBox="0 0 8 14"
        ...
        <div class="nws-modal-header">
          <h3 class="middleTitle">${translate("modal.ledger.connecting")} ${selectedAccounts.length} ${translate("modal.ledger.ofAccounts")}</h3><button class="close-button"><svg xmlns="http://www.w3.org/2000/svg"
              height="24" viewBox="0 0 24 24" width="24" fill="#C1C1C1">
              <path d="M0 0h24v24H0z" fill="none"></path>
              <path
                d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z">
  ...
  `;
    ...
    (_c = document.getElementById("finish-button")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
      try {
        if (!modalState) {
          return;
        }
        ...
        modalState.emitter.emit("onHide", {
          hideReason: "wallet-navigation"
        });
      } catch (err) {
        yield renderWalletConnectionFailed(module, err);
      }
    }));
  });
}

function renderNoLedgerAccountsFound(module) {
  var _a;
...
function renderWalletConnecting(module = null) {
  return __awaiter(this, void 0, void 0, function* () {
    document.querySelector(".modal-right").innerHTML = `
    <div class="nws-modal-body">
      <div class="nws-modal-header">
      ...
      <div class="connecting-wrapper">
        <div class="content">
          <div class="icon">
            <img src="${module === null || module === void 0 ? void 0 : module.metadata.iconUrl}" alt="${module === null || module === void 0 ? void 0 : module.metadata.name}">
          </div>
          ...
          <div class="connecting-details">
            <div class="spinner"><img
                ...
                <span>
                  ${translate("modal.wallet.connectingTo")} ${module === null || module === void 0 ? void 0 : module.metadata.name}...
                </span>
        </div>
          <div class="connecting-message">
            <span>
              ${translate("modal.wallet.connectingMessage." + (module === null || module === void 0 ? void 0 : module.type))}
            </span>
          </div>
      </div>
    </div>
...
function renderSpecifyDerivationPath(module) {
  ...
  derivationPathIndexElement.innerText = modalState.derivationPath.slice(-2, -1);
  (_a = document.getElementById("increase-index-button")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
    ...
    modalState.derivationPath = modalState.derivationPath.slice(0, -2) + nextIndex.toString() + "'";
  ...
  (_d = document.getElementById("scan-button")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => __awaiter(this, void 0, void 0, function* () {
    try {
      const wallet = yield module.wallet();
...
function renderConnectHardwareWallet(module) {
  ...
  (_b = document.getElementById("specify-derivation-path-button")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
    renderSpecifyDerivationPath(module);
  });
}
...
function renderWalletNotInstalled(module) {
  ...
  `;
  (_a = document.getElementById("refresh-page-lint")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", () => {
...
function renderWalletAccount(module = null) {
  return __awaiter(this, void 0, void 0, function* () {
    document.querySelector(".modal-right").innerHTML = `
    <div class="nws-modal-body">
    <div class="nws-modal-header">
...
function renderScanQRCode(module, params) {
  var _a, _b, _c;

  return __awaiter(this, void 0, void 0, function* () {
    function formatQRCodeImage(data) {
      return __awaiter(this, void 0, void 0, function* () {
        const dataString = yield QRCode.toString(data, {
          margin: 0,
          type: "svg"
        });
        return dataString;
    ...
    const svg = yield formatQRCodeImage(params.uri);
    document.querySelector(".modal-right").innerHTML = `
      <div class="nws-modal-body">
        ...
        <footer class="footer">
          <p>${translate("modal.qr.preferTheOfficial")} ${module.metadata.name}?</p>
...
`;
    ...
    (_b = document.getElementById("copy-uri-to-clipboard")) === null || _b === void 0 ? void 0 : _b.addEventListener("click", () => {
      if (!params.uri) {
        return;
      }
    ...
    (_c = document.getElementById("default-modal-trigger")) === null || _c === void 0 ? void 0 : _c.addEventListener("click", () => {
...
const getAccountIds = publicKey => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const response = yield fetch(`${modalState.selector.options.network.indexerUrl}/publicKey/ed25519:${publicKey}/accounts`);
...
const resolveAccounts = wallet => __awaiter(void 0, void 0, void 0, function* () {
  ...
  const publicKey = yield wallet.getPublicKey(modalState.derivationPath);
...
function connectToWallet(module, qrCodeModal = false) {
  return __awaiter(this, void 0, void 0, function* () {
    if (!modalState) {
      return;
    }
    ...
    try {
      ...
      if (module.metadata.deprecated) {
        return renderWalletConnectionFailed(module, new Error("Wallet is deprecated"));
      }

      const wallet = yield module.wallet();
      yield renderWalletConnecting(module);
      ...
      if (wallet.type === "bridge") {
        const subscription = modalState.selector.on("uriChanged", ({
          uri
        }) => {
      ...
      yield renderWalletConnectionFailed(module, new Error(`Failed to sign in with ${name}: ${message}`));
    }
  });
}
...
function renderOptionsList(parentClass, modules) {
  ...
  for (let i = 0; i < modules.length; i++) {
    ...
    (_a = document.querySelector(parentClass)) === null || _a === void 0 ? void 0 : _a.insertAdjacentHTML("beforeend", `
        <div tabindex="0" class="single-wallet ${module.id === modalState.selector.store.getState().selectedWalletId ? "selected-wallet connected-wallet" : ""} sidebar ${module.metadata.deprecated ? "deprecated-wallet" : ""} ${module.id}" id="module-${module.id}">
...
function renderModal() {
  ...
  modalState.modules.forEach(module => {
    if (modalState === null || modalState === void 0 ? void 0 : modalState.selector.store.getState().recentlySignedInWallets.includes(module.id)) {
  ...
  if (modalState.selector.options.optimizeWalletOrder && recentlySignedInWallets.length > 0) {
    (_a = document.querySelector(".wallet-options-wrapper")) === null || _a === void 0 ? void 0 : _a.insertAdjacentHTML("beforeend", `
      ...
      `);
    (_b = document.querySelector(".wallet-options-wrapper")) === null || _b === void 0 ? void 0 : _b.insertAdjacentHTML("beforeend", `
      <div class="options-list-section">
    ...
    (_c = document.querySelector(".wallet-options-wrapper")) === null || _c === void 0 ? void 0 : _c.insertAdjacentHTML("beforeend", `<div class="options-list"></div>`);
    renderOptionsList(".options-list", modalState.modules);
  }

  (_d = document.querySelector(".nws-modal-overlay")) === null || _d === void 0 ? void 0 : _d.addEventListener("click", () => {
    if (!modalState) {
      return;
    }
...
function goToWallet(module) {
  ...
  const {
    networkId
  } = modalState.selector.options.network;
  let url = "";
    ...
    <div class="nws-modal-body">
      <div class="wallet-home-wrapper">
        ...
        <button class="back-button" id="back-button"><svg width="8" height="14" viewBox="0 0 8 14"
          ...
          <div class="nws-modal-header">
            <h3 class="middleTitle -open">${translate("modal.wallet.getAWallet")}</h3><button class="close-button"><svg xmlns="http://www.w3.org/2000/svg"
                height="24" viewBox="0 0 24 24" width="24" fill="#C1C1C1">
                <path d="M0 0h24v24H0z" fill="none"></path>
                <path
                  d="M19 6.41L17.59 5 12 10.59 6.41 5 5 6.41 10.59 12 5 17.59 6.41 19 12 13.41 17.59 19 19 17.59 13.41 12z">
