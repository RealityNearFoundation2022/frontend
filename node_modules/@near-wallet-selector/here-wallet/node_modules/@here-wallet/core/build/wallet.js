...
class HereWallet {
    ...
    getHereBalance(id) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const hereCoins = yield account.viewFunction(contract, "ft_balance_of", params).catch(() => "0");
    ...
    signIn(_a = {}) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            if (contractId == null) {
                const { accountId } = yield this.signMessage(Object.assign({ receiver: window.location.host, message: "Sign this message to sign in" }, delegate));
