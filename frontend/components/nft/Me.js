...
import { login, nft_tokens_for_owner, storage_minimum_balance, storage_deposit, nft_approve, nft_mint } from '../../assets/js/near/utils'
            ...
            <div className="wrapper">
              {currentUser ? (
                ...
                <div>
                  ...
                  <button className="btn btn-primary btn-xl" onClick={login}>Sign in</button>
                </div>
              )}
